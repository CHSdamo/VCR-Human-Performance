...
class Visualizer(object):
    ...
    def __post_init__(self) -> None:
        ...
        self.vcr_imgs = Path(self.vcr_imgs)
    ...
    def get_img(self) -> Image:
        """Get the required PIL Image"""
        return PIL.Image.open(self.vcr_imgs)

    def get_metadata(self) -> Dict:
        """Get the required meta data"""
        return json.load((self.vcr_tdir).open('r'))
    ...
    def get_mask_ann_img(self, draw_box: bool = True,  draw_mask: bool = True,
        ...
        if draw_box:
            ...
            font_to_use = ImageFont.truetype(fontPath, 20)
    ...
    def get_qar(self) -> Dict[str, Union[List[str], str]]:
        """Question, Answers, Reasoning, Labels at once"""
        #out_dict = OrderedDict()
        out_dict = {'question': self.get_question(), 'answer_choices': self.get_answers(),
                    'answer_label': self.ann['answer_label'], 'rationale_choices': self.get_reasons(),
                    'rationale_label': self.ann['rationale_label']}
        return out_dict
