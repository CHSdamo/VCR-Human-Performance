...
#   image_on_canvas = canvas.create_image(1000, 0, anchor='n', image=tk_image)
    ...
    l2.place(relx=0.09, rely=0.98, anchor='w')

    l3 = tk.Label(window, bg='LightPink', font=('Arial', 20),
                 text='Question: ' + dct['question'])
    l3.place(relx=0.09, rely=0.94, anchor='w')
